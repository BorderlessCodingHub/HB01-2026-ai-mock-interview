/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 078eca61d79683ee286f544c0b62cc0e)
// Runtime types generated with workerd@1.20260811.1 2025-01-15 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXT_PUBLIC_SERVER_URL: string;
	NEXT_PUBLIC_BORDERLESS_SIGNUP_URL: string;
	BETTER_AUTH_SECRET: string;
	BETTER_AUTH_URL: string;
	BORDERLESS_API_BASE: string;
	SERVER_INTERNAL_URL: string;
	INTERNAL_AUTH_SYNC_SECRET: string;
	WORKER_SELF_REFERENCE: Fetcher /* ai-mock-interview */;
}
